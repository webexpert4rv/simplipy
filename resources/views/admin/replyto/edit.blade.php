                        ...
                        <div class="x_content">
                            ...
                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left admin_create"
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-2" for="last_name">Agent<span
                                                class="required">*</span>
                                    </label>
                                        ...
                                        <select id="agent_field" class="form-control" disabled>
                                            @if(!empty($agents))
                                                @foreach($agents as $agent)
                                                    <option value="{{$agent->id }}" {{ ($replyto->user_id == $agent->id) ? 'selected' : ''}}>{{ $agent->userProfile->first_name }} {{ $agent->userProfile->last_name }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input value="{{ $replyto->email,old('email') }}" type="email" name="email" required="required"
