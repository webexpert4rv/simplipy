        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    <ul class="breadcrumb">
                        <li>
                            <a href="{{route('monthlyReports.index')}}">Reporting</a>
                        </li>
                      {{--  <li class="active">
                           Message
                        </li>--}}
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        {{-- <div class="x_content report_disable"> --}}
                            ...
                            {!! Form::open(['files' => true,'route' => ['monthlyReports.update', 'id' => $model->id], 'class' => 'form-horizontal form-label-left', 'id' => 'demo-form2']) !!}
