                          ...
                          {{--  <p class="main_title">Fields marked with an asterisk * are mandatory.</p>--}}
                            <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"
                                ...
                                <div class="first_section">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Civilité <span
                                                    class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select required="required" name="center_id"
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first_name">Prénom et nom<span
                                                    class="required">*</span>
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="mob">Numéro de téléphone
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" name="to_email" class="form-control col-md-7 col-xs-12" value="{{old('to_email')}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="third_section">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="mob">Object du mail
                                        </label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" name="email_subject" class="form-control col-md-7 col-xs-12" value="{{old('email_subject')}}">
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3 report_btn">
                                        <button type="submit" class="btn btn-success" name="mail_submit" value="mail_submit">Valider</button>
                                    </div>
                                </div>
...
@section('scripts')
    ...
    <script>
         ...
         $(document).ready(function(){
            ...
            $('#demo-form2').on('keyup keypress', function(e) { var keyCode = e.keyCode || e.which; if (keyCode === 13) { e.preventDefault(); return false; } });
